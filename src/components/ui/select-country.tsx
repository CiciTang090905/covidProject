...
const SelectCountry = () => {
  ...
  const handleOnCountryChange = (value: string) => { //handleOnCountryChange finds the matching entry and updates state.
      ...
      <div className="flex flex-col gap-5 justify-start w-full">
        ...
        <Select value={country.code} onValueChange={handleOnCountryChange}>
          ...
          <SelectContent>
            ...
            ))} //javascript inside JSX, only accept expressions
          </SelectContent>
        </Select>
      </div>
    </div>
